...
namespace Basic.Reference.Assemblies
{
    ...
    public static partial class NetStandard13
    {
        public static class ReferenceInfos
        {
            ...
            /// </summary>
            public static ReferenceInfo MicrosoftWin32Primitives => new ReferenceInfo("Microsoft.Win32.Primitives.dll", Resources.MicrosoftWin32Primitives, NetStandard13.References.MicrosoftWin32Primitives, global::System.Guid.Parse("91e3a81f-b201-4e0c-8268-d6f5ac7fb341"));

            /// <summary>
            /// The <see cref="ReferenceInfo"/> for System.AppContext.dll
            /// </summary>
            public static ReferenceInfo SystemAppContext => new ReferenceInfo("System.AppContext.dll", Resources.SystemAppContext, NetStandard13.References.SystemAppContext, global::System.Guid.Parse("7d0ca87f-e540-4a1f-a8bc-e516f32f5d53"));

            /// <summary>
            /// The <see cref="ReferenceInfo"/> for System.Collections.Concurrent.dll
            /// </summary>
            public static ReferenceInfo SystemCollectionsConcurrent => new ReferenceInfo("System.Collections.Concurrent.dll", Resources.SystemCollectionsConcurrent, NetStandard13.References.SystemCollectionsConcurrent, global::System.Guid.Parse("286808d4-32ac-4189-8a2b-7545fa4b6086"));

            /// <summary>
            /// The <see cref="ReferenceInfo"/> for System.Collections.dll
            /// </summary>
            public static ReferenceInfo SystemCollections => new ReferenceInfo("System.Collections.dll", Resources.SystemCollections, NetStandard13.References.SystemCollections, global::System.Guid.Parse("dc8e993a-f57c-4208-9b48-c9de723bd9ae"));

            /// <summary>
            /// The <see cref="ReferenceInfo"/> for System.Console.dll
            /// </summary>
            public static ReferenceInfo SystemConsole => new ReferenceInfo("System.Console.dll", Resources.SystemConsole, NetStandard13.References.SystemConsole, global::System.Guid.Parse("7c306057-d8d3-4710-acd5-48a6a7416da5"));

            /// <summary>
            /// The <see cref="ReferenceInfo"/> for System.Diagnostics.Debug.dll
            /// </summary>
            public static ReferenceInfo SystemDiagnosticsDebug => new ReferenceInfo("System.Diagnostics.Debug.dll", Resources.SystemDiagnosticsDebug, NetStandard13.References.SystemDiagnosticsDebug, global::System.Guid.Parse("e8da1e39-cb54-4c34-9233-b0dea7f24136"));

            /// <summary>
            /// The <see cref="ReferenceInfo"/> for System.Diagnostics.FileVersionInfo.dll
            /// </summary>
            public static ReferenceInfo SystemDiagnosticsFileVersionInfo => new ReferenceInfo("System.Diagnostics.FileVersionInfo.dll", Resources.SystemDiagnosticsFileVersionInfo, NetStandard13.References.SystemDiagnosticsFileVersionInfo, global::System.Guid.Parse("965b58bc-1fd3-48cf-be90-27a5a9091d07"));

            /// <summary>
            /// The <see cref="ReferenceInfo"/> for System.Diagnostics.Process.dll
            /// </summary>
            public static ReferenceInfo SystemDiagnosticsProcess => new ReferenceInfo("System.Diagnostics.Process.dll", Resources.SystemDiagnosticsProcess, NetStandard13.References.SystemDiagnosticsProcess, global::System.Guid.Parse("d19ddd95-cd72-4313-8ec4-6f7d58c446f5"));

            /// <summary>
            /// The <see cref="ReferenceInfo"/> for System.Diagnostics.Tools.dll
            /// </summary>
            public static ReferenceInfo SystemDiagnosticsTools => new ReferenceInfo("System.Diagnostics.Tools.dll", Resources.SystemDiagnosticsTools, NetStandard13.References.SystemDiagnosticsTools, global::System.Guid.Parse("d485d7f1-0044-42ba-9c46-e593d82a4cbd"));

            /// <summary>
            /// The <see cref="ReferenceInfo"/> for System.Diagnostics.Tracing.dll
            /// </summary>
            public static ReferenceInfo SystemDiagnosticsTracing => new ReferenceInfo("System.Diagnostics.Tracing.dll", Resources.SystemDiagnosticsTracing, NetStandard13.References.SystemDiagnosticsTracing, global::System.Guid.Parse("0c51d40e-31ef-45f1-85f4-627c5df009b7"));

            /// <summary>
            /// The <see cref="ReferenceInfo"/> for System.Globalization.Calendars.dll
            /// </summary>
            public static ReferenceInfo SystemGlobalizationCalendars => new ReferenceInfo("System.Globalization.Calendars.dll", Resources.SystemGlobalizationCalendars, NetStandard13.References.SystemGlobalizationCalendars, global::System.Guid.Parse("fcf5f760-0ab6-4607-bac7-3a4bac4b4c59"));
            ...
            /// </summary>
            public static ReferenceInfo SystemNetHttp => new ReferenceInfo("System.Net.Http.dll", Resources.SystemNetHttp, NetStandard13.References.SystemNetHttp, global::System.Guid.Parse("366072f2-59a8-4d1b-b1fb-4d4357b9fdcc"));

            /// <summary>
            /// The <see cref="ReferenceInfo"/> for System.Net.Primitives.dll
            /// </summary>
            public static ReferenceInfo SystemNetPrimitives => new ReferenceInfo("System.Net.Primitives.dll", Resources.SystemNetPrimitives, NetStandard13.References.SystemNetPrimitives, global::System.Guid.Parse("bc474da5-2dd5-44e2-ae42-214b1412c875"));

            /// <summary>
            /// The <see cref="ReferenceInfo"/> for System.Net.Security.dll
            /// </summary>
            public static ReferenceInfo SystemNetSecurity => new ReferenceInfo("System.Net.Security.dll", Resources.SystemNetSecurity, NetStandard13.References.SystemNetSecurity, global::System.Guid.Parse("e8fb5b9d-2d54-468d-bd4f-6dbbe5a9ff8e"));

            /// <summary>
            /// The <see cref="ReferenceInfo"/> for System.Net.Sockets.dll
            /// </summary>
            public static ReferenceInfo SystemNetSockets => new ReferenceInfo("System.Net.Sockets.dll", Resources.SystemNetSockets, NetStandard13.References.SystemNetSockets, global::System.Guid.Parse("d896fe9a-bb21-409d-9c3b-3b3160ca66f7"));
            ...
            /// </summary>
            public static ReferenceInfo SystemRuntimeExtensions => new ReferenceInfo("System.Runtime.Extensions.dll", Resources.SystemRuntimeExtensions, NetStandard13.References.SystemRuntimeExtensions, global::System.Guid.Parse("2250f35c-4847-4d0d-b225-47e35e39b015"));
            ...
            /// </summary>
            public static ReferenceInfo SystemRuntimeNumerics => new ReferenceInfo("System.Runtime.Numerics.dll", Resources.SystemRuntimeNumerics, NetStandard13.References.SystemRuntimeNumerics, global::System.Guid.Parse("9b6cc1ed-d04a-4881-b09f-526b86acec1c"));
            ...
            /// </summary>
            public static ReferenceInfo SystemSecurityAccessControl => new ReferenceInfo("System.Security.AccessControl.dll", Resources.SystemSecurityAccessControl, NetStandard13.References.SystemSecurityAccessControl, global::System.Guid.Parse("9ca72926-f8b2-47b1-baf9-c48b67684ffe"));

            /// <summary>
            /// The <see cref="ReferenceInfo"/> for System.Security.Claims.dll
            /// </summary>
            public static ReferenceInfo SystemSecurityClaims => new ReferenceInfo("System.Security.Claims.dll", Resources.SystemSecurityClaims, NetStandard13.References.SystemSecurityClaims, global::System.Guid.Parse("af2a2068-32c3-4e61-af21-ae4ca2688b86"));

            /// <summary>
            /// The <see cref="ReferenceInfo"/> for System.Security.Cryptography.Algorithms.dll
            /// </summary>
            public static ReferenceInfo SystemSecurityCryptographyAlgorithms => new ReferenceInfo("System.Security.Cryptography.Algorithms.dll", Resources.SystemSecurityCryptographyAlgorithms, NetStandard13.References.SystemSecurityCryptographyAlgorithms, global::System.Guid.Parse("6b686dbb-17b1-4833-85e4-9a2b63f00600"));

            /// <summary>
            /// The <see cref="ReferenceInfo"/> for System.Security.Cryptography.Csp.dll
            /// </summary>
            public static ReferenceInfo SystemSecurityCryptographyCsp => new ReferenceInfo("System.Security.Cryptography.Csp.dll", Resources.SystemSecurityCryptographyCsp, NetStandard13.References.SystemSecurityCryptographyCsp, global::System.Guid.Parse("9ad5797a-13a1-49b7-ad60-2e89f8d4dcd2"));

            /// <summary>
            /// The <see cref="ReferenceInfo"/> for System.Security.Cryptography.Encoding.dll
            /// </summary>
            public static ReferenceInfo SystemSecurityCryptographyEncoding => new ReferenceInfo("System.Security.Cryptography.Encoding.dll", Resources.SystemSecurityCryptographyEncoding, NetStandard13.References.SystemSecurityCryptographyEncoding, global::System.Guid.Parse("8c839bdf-05b6-48d3-92f2-caa183da320a"));

            /// <summary>
            /// The <see cref="ReferenceInfo"/> for System.Security.Cryptography.Primitives.dll
            /// </summary>
            public static ReferenceInfo SystemSecurityCryptographyPrimitives => new ReferenceInfo("System.Security.Cryptography.Primitives.dll", Resources.SystemSecurityCryptographyPrimitives, NetStandard13.References.SystemSecurityCryptographyPrimitives, global::System.Guid.Parse("efe1d3b2-6c05-46a1-b158-004e5343cda1"));
            ...
            /// </summary>
            public static ReferenceInfo SystemValueTuple => new ReferenceInfo("System.ValueTuple.dll", Resources.SystemValueTuple, NetStandard13.References.SystemValueTuple, global::System.Guid.Parse("0e36256c-d941-414e-a037-63caa0544d38"));

            /// <summary>
            /// The <see cref="ReferenceInfo"/> for System.Xml.ReaderWriter.dll
            /// </summary>
            public static ReferenceInfo SystemXmlReaderWriter => new ReferenceInfo("System.Xml.ReaderWriter.dll", Resources.SystemXmlReaderWriter, NetStandard13.References.SystemXmlReaderWriter, global::System.Guid.Parse("50cbb506-90fe-4b79-a1f9-191d8ca9373f"));
